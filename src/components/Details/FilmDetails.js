...
import { Layout, Button, Tooltip, Image } from 'antd';
			...
			<div className={styles.filmDetails}>
				...
				<div className={styles.textContainer}>
					<div className={styles.titleYear}>
						<h1 id={styles.title} className={styles.textStyle}>
							{film.title}
							<span
								id={styles.release}
					...
					<h3 id={styles.tagline} className={styles.textStyle}>
						"{film.tagline}"
					</h3>
					...
					<div className={styles.buttonsContainer}>
						...
						{currentFilm ? (
							<StarRating
								userRating={currentFilm.rating}
								seen={currentFilm.watched}
								id={currentFilm.id}
